...
class Main extends Component {
  webAppWarningModalRef = createRef();

  componentDidMount() {
    this.webAppWarningModalInstance = M.Modal.init(this.webAppWarningModalRef.current);
  }

  render() {
    const {toggleTheme, getTheme} = this.props;
    ...
    return (
      <div id="main">
        ...
        <div className="container center">
          ...
          <div className="row">
            <div className="col offset-s2 s4">
              <button className="btn center brand-text" onClick={() => this.webAppWarningModalInstance.open()}>
        ...
        <div className="modal" ref={this.webAppWarningModalRef}>
          <div className="modal-content container-fluid center">
            <h3 className="red-text">Warning</h3>
            <p>The web version of Rainbow Board is an older version(v0.5.4). Please download the desktop app to get the latest features and best performance.</p>
          </div>
          <div className="modal-footer container">
            <button className="btn right" onClick={() => this.webAppWarningModalInstance.close()}>Close</button>
            <NavLink className="btn left" to="/pages">Continue</NavLink>
          </div>
        </div>
